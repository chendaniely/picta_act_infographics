...
LABEL maintainer="Daniel Chen <chendaniely@gmail.com>"

# Copied from rocker/verse to install TeX
...
##### END rocker/verse code

COPY 00-install 00-install
RUN Rscript ./00-install/01-install_rpkgs.R
#RUN Rscript -e "tinytex::install_tinytex()"
#RUN Rscript -e "tinytex:::install_yihui_pkgs()"

RUN tlmgr install graphics-def oberdiek iftex ifxetex
...
COPY pictaACTinfographics /srv/shiny-server/pictaACTinfographics
