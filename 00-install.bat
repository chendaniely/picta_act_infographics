C:\"Program Files"\R\R-3.6.2\bin\Rscript.exe -e "install.packages(c('ggplot2', 'png', 'extrafont', 'knitr', 'rmarkdown', 'shiny', 'shinydashboard', 'tinytex', 'here', 'RCurl', 'devtools'), repo = 'https://cloud.r-project.org/')"
