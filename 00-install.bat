"Rscript.exe - Shortcut.lnk" -e "install.packages(c('ggplot2', 'png', 'extrafont', 'knitr', 'rmarkdown', 'shiny', 'shinydashboard', 'tinytex', 'here', 'RCurl', 'devtools'), repo = 'https://cloud.r-project.org/')"
