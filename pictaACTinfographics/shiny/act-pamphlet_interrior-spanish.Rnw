...
\noindent\fontsize{12}{12}\selectfont \textbf{NIVEL DEL CONTROL DEL ASMA DE \Sexpr{stringr::str_to_upper(PT_VALUES_ASTHMA$display_name)}}
...
% score statement
\vspace{24pt}
\noindent\hspace{0.75in}\noindent\fontsize{22}{22}\selectfont
\Sexpr{PT_VALUES_ASTHMA$asthma_score_statement}

% progress statement
\noindent\hspace{0.75in}\noindent\fontsize{22}{22}\selectfont
\Sexpr{PT_VALUES_ASTHMA$asthma_progress_statment}
...
\vfill \hfill \noindent\fontsize{14}{14}\selectfont
\Sexpr{PT_VALUES_ASTHMA$today_date_text}
